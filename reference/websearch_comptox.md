...
websearch_comptox(
  ...
  downloadItems = c("DTXCID", "CASRN", "INCHIKEY", "IUPAC_NAME", "SMILES",
    ...
    "AVERAGE_MASS", "MONOISOTOPIC_MASS", "TOXPRINTS_CHEMOTYPER", "TOXPRINTS_FINGERPRINT",
    "QC_LEVEL", "SAFETY_DATA", "EXPOCAST", "DATA_SOURCES", "TOXVAL_DATA", "IRIS_LINK",
    "PPRTV_LINK", "WIKIPEDIA_ARTICLE", "QC_NOTES", "BIOCONCENTRATION_FACTOR_TEST_PRED",
