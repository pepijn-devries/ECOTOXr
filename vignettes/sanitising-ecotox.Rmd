...
(`download_ecotox_data()`), contain all required data. As documented by the EPA most
...
<!--   mutate( -->
<!--     conc1_combined = conc1_mean * conc1_unit, -->
<!--     conc1_standard = { -->
<!--       result <- -->
<!--         lapply(conc1_combined, \(x) { -->
<!--           tryCatch({ units::set_units(x, "ug/L") }, -->
<!--                    error = function(e) { units::set_units(NA, "ug/L") }) -->
<!--         }) -->
<!--       do.call(c, result) -->
<!--     }) -->
<!-- ``` -->
...
(publication date), or excremental information (application date). These
