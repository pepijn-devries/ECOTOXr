...
![From De Vries et al. (2024); Creative commons (https://creativecommons.org/licenses/by/4.0/)](man/figures/graphical-abstract.png)
...
either the simple query language (SQL) or `dplyr` verbs. More details in the following vignette:
